import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, unref, ref, computed, defineComponent, h, Fragment, createVNode, Text, Suspense, nextTick, mergeProps, provide, watch, readonly, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { k as createHooks, l as getContext, h as createError$1, t as toRouteMatcher, m as createRouter, o as defu, s as sanitizeStatusCode, q as executeAsync, r as setCookie, v as getHeader, w as getRequestHeaders, x as defuFn, y as klona, z as destr, A as parse$1, B as getRequestHeader, C as getCookie, D as deleteCookie } from '../_/nitro.mjs';
...
import { faMoon, faSun, faCalendar, faGlobe, faLink, faExternalLinkAlt, faChevronRight, faChevronDown, faGraduationCap, faCog, faFileCode, faDatabase, faServer, faLaptopCode, faCode, faBriefcase, faEnvelope, faUser } from '@fortawesome/free-solid-svg-icons';
import { faGit, faGoogle, faJava, faPython, faBootstrap, faAws, faApple, faAndroid, faVuejs, faReact, faNode, faJs, faCss3, faHtml5, faTwitter, faLinkedin, faGithub } from '@fortawesome/free-brands-svg-icons';
...
const disable_45vue_45transitions_45global = defineNuxtRouteMiddleware((to) => {
  {
    return;
  }
});
...
const supabase_server_NZuw_NDm2ZtOgvg4QqXN_Xqdg_KPvGuBBWKrLH15GWY = defineNuxtPlugin({
  name: "supabase",
  enforce: "pre",
  async setup({ provide }) {
    let __temp, __restore;
...
const icons = { freeFasFaUser: faUser, freeFasFaEnvelope: faEnvelope, freeFasFaBriefcase: faBriefcase, freeFasFaCode: faCode, freeFasFaLaptopCode: faLaptopCode, freeFasFaServer: faServer, freeFasFaDatabase: faDatabase, freeFasFaFileCode: faFileCode, freeFasFaCog: faCog, freeFasFaGraduationCap: faGraduationCap, freeFasFaChevronDown: faChevronDown, freeFasFaChevronRight: faChevronRight, freeFasFaExternalLinkAlt: faExternalLinkAlt, freeFasFaLink: faLink, freeFasFaGlobe: faGlobe, freeFasFaCalendar: faCalendar, freeFasFaSun: faSun, freeFasFaMoon: faMoon, freeFabFaGithub: faGithub, freeFabFaLinkedin: faLinkedin, freeFabFaTwitter: faTwitter, freeFabFaHtml5: faHtml5, freeFabFaCss3: faCss3, freeFabFaJs: faJs, freeFabFaNode: faNode, freeFabFaReact: faReact, freeFabFaVuejs: faVuejs, freeFabFaAndroid: faAndroid, freeFabFaApple: faApple, freeFabFaAws: faAws, freeFabFaBootstrap: faBootstrap, freeFabFaPython: faPython, freeFabFaJava: faJava, freeFabFaGoogle: faGoogle, freeFabFaGit: faGit };

config.autoAddCss = false;
const fontawesome_6yjpF5YWnI0c3JEjQBpt6Zpb76oFn37ONKmsKyC83Ck = defineNuxtPlugin(() => {
  library.add(icons);
});
...
const useTranslation = () => {
  ...
  const translate = (field) => {
    ...
    if (typeof field === "object" && field !== null) {
      ...
      return field[currentLocale] || field[defaultLocale] || Object.values(field)[0] || "";
    }
    return String(field);
  };
  const translateObject = (obj) => {
    ...
    for (const key in result) {
      if (typeof result[key] === "object" && result[key] !== null && !Array.isArray(result[key]) && (result[key].en || result[key].ru)) {
        result[key] = translate(result[key]);
      }
    }
    return result;
  };
  const translateArray = (items) => {
    if (!items || !Array.isArray(items)) return [];
    return items.map((item) => translateObject(item));
  };
  const setupPageMeta = (titleKey, descriptionKey) => {
    useHead({
      title: t(titleKey),
      meta: [
  ...
  setup(__props) {
    ...
    useHead({
      ...
      meta: [
        ...
        { property: "og:url", content: "https://meiirzhan-portfolio.com" },
        ...
        { name: "twitter:url", content: "https://meiirzhan-portfolio.com" },
      ...
      link: [
        ...
        // Canonical URL
        { rel: "canonical", href: "https://meiirzhan-portfolio.com" }
      ],
      // HTML attributes
      htmlAttrs: {
        lang: currentLang,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-neutral-900 text-white" }, _attrs))}>`);
...
export { useTranslation as a, useRoute as b, encodeParam as c, useNuxtApp as d, encodePath as e, useRuntimeConfig as f, useAppConfig as g, hasProtocol as h, asyncDataDefaults as i, joinURL as j, createError as k, useRouter as l, parseQuery as m, navigateTo as n, withTrailingSlash as o, parseURL as p, withoutTrailingSlash as q, resolveRouteObject$1 as r, nuxtLinkDefaults as s, server as t, useHead as u, withLeadingSlash as w };
