...
function hash$1(input) {
  return digest$1(serialize$1(input));
}
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "6356b4f3-f73e-4c1c-b9cb-ca6e309c20e5",
  ...
  "public": {
    ...
    "supabaseUrl": "https://mzxfwxkqajfjdixlphqr.supabase.co",
    "supabaseKey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im16eGZ3eGtxYWpmamRpeGxwaHFyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDE3ODQ4MjAsImV4cCI6MjA1NzM2MDgyMH0.Xi17NVBTobU-eHg0e2owoRbAMX9TsIgepCuMGlIABQI",
    "i18n": {
      "baseUrl": "",
      "defaultLocale": "en",
    ...
    "supabase": {
      "url": "https://mzxfwxkqajfjdixlphqr.supabase.co",
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im16eGZ3eGtxYWpmamRpeGxwaHFyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDE3ODQ4MjAsImV4cCI6MjA1NzM2MDgyMH0.Xi17NVBTobU-eHg0e2owoRbAMX9TsIgepCuMGlIABQI",
      "redirect": false,
      "redirectOptions": {
        "login": "/login",
        "callback": "/confirm",
      ...
      "cookieName": "sb",
      "cookiePrefix": "sb-mzxfwxkqajfjdixlphqr-auth-token",
      "useSsrCookies": true,
      "cookieOptions": {
        "maxAge": 28800,
        "sameSite": "lax",
...
const _81YmrO = defineCachedEventHandler(async (event) => {
...
const _7CkIBI = lazyEventHandler(() => {
...
const _lazy_UWwPte = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_UWwPte, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _81YmrO, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _7CkIBI, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_UWwPte, lazy: true, middleware: false, method: undefined }
];
...
export { parse as A, getRequestHeader as B, getCookie as C, deleteCookie as D, useRuntimeConfig as a, buildAssetsURL as b, getResponseStatusText as c, getResponseStatus as d, defineRenderHandler as e, getQuery as f, getRouteRulesForPath as g, createError$1 as h, getRouteRules as i, joinHeaders as j, createHooks as k, getContext as l, createRouter$1 as m, normalizeCookieHeader as n, defu as o, publicAssetsURL as p, executeAsync as q, setCookie as r, sanitizeStatusCode as s, toRouteMatcher as t, useNitroApp as u, getHeader as v, getRequestHeaders as w, defuFn as x, klona as y, destr as z };
